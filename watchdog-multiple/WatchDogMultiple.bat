...
start D:/vvvv_45beta33.7_x86/vvvv.exe /allowmultiple /o "E:\git\airslice\watchdog-batch-vvvv\_demoworks\demoWork1.v4p"
ping 1 -n 5 -w 1000 2>nul 1>nul 
start D:/vvvv_45beta33.7_x86/vvvv.exe /allowmultiple /o "E:\git\airslice\watchdog-batch-vvvv\_demoworks\demoWork2.v4p"
:RESTART
